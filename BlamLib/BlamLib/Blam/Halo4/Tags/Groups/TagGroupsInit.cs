...
// 			srhscf.Definition = new Tags.scenario_hs_source_file_group().State;
			//igpd.Definition = new Tags.incident_global_properties_definition().State;
...
// 			mffn.Definition = new Tags.muffin_group().State;
			mgee.Definition = new Tags.multiplayer_effects_group().State;
...
// 			uihg.Definition = new Tags.user_interface_hud_globals_definition_group().State;
// 			uise.Definition = new Tags.user_interface_sounds_definition_group().State;
// 			uiss.Definition = new Tags.style_sheet_list_group().State;
